...
import os
from Sentiment_Analysis.constant import training_pipeline
...
#             config.artifact_dir, config.DATA_VALIDATION_DIR_NAME
#         )

#         self.valid_data_dir = os.path.join(
#             self.data_validation_dir, config.DATA_VALIDATION_VALID_DIR
#         )
